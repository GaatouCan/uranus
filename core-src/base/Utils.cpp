...
namespace utils {
    ...
    long long ToUnixTime(const SystemTimePoint point) {
    ...
    unsigned GetDayOfWeek(const SystemTimePoint point) {
    ...
    int GetDaysGone(const SystemTimePoint former, const SystemTimePoint latter) {
        if (latter <= former)
            return 0;
    ...
    SystemTimePoint GetDayZeroTime(const SystemTimePoint point) {
    ...
    bool IsSameWeek(const SystemTimePoint former, const SystemTimePoint latter) {
        if (latter <= former)
            return false;
    ...
    bool IsSameMonth(const SystemTimePoint former, const SystemTimePoint latter) {
        if (latter <= former)
            return false;
